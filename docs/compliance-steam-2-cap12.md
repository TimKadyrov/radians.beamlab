# Compliance loop: STEAM-2 cap12 (co-frequency beam capacity 12; a cap that binds)

*Produced by `dotnet run --project tests/radians.beamlab.checks -- loop "STEAM-2-cap12.opprofile.json" "STEAM-2.orbitdesign.json" 0.1 60 0 60 10`.*
*Date: 2026-09-07. Wall clock 29.4 min.*
...
- Depth: 144 steps / 6560480 link samples, latitude band 10 deg.
- Derived set: min_exclude -45:22.0/-35:22.0/-25:22.0/-15:22.0/-5:22.0/5:22.0/15:22.0/25:22.0/35:22.0/45:22.0; min_elev -45:40.0/-35:40.0/-25:40.0/-15:40.0/-5:40.0/5:40.0/15:40.0/25:40.0/35:40.0/45:40.0; max_co_freq -45:4/-35:4/-25:4/-15:4/-5:4/5:4/15:4/25:4/35:4/45:4; max_co_freq_sat 48; min_angle es 0.0 / sat 2.2; es_lat -50..50
...
| 30 | -5.7 | -10.6 | 4.9 | yes |
| 40 | -6.9 | -14.4 | 7.5 | yes |
| 50 | -11.9 | -21.7 | 9.8 | yes |
| 60 | -11.7 | -18.6 | 6.9 | yes |
...
- Operation profile (the truth as run): `dataset\margin\steam-2-cap12\steam-2-cap12.opprofile.json`
- Derived R set (S.1503-4 Part B): `dataset\margin\steam-2-cap12\steam-2-cap12.operparams.xml`
- Derived R set, designer format (open with the operating-parameters designer): `dataset\margin\steam-2-cap12\steam-2-cap12.operparams.json`
- Declared pfd mask: `dataset\margin\steam-2-cap12\steam-2-cap12.mask.lat10p0-ae1p0-svc-50to50-vc3f46b06.xml`
