# Compliance loop: STEAM-2-16d (STEAM-2 profile unchanged; 16.0 d depth run, declaration reused from the record)

*Produced by `dotnet run --project tests/radians.beamlab.checks -- loop "STEAM-2-16d.opprofile.json" "STEAM-2.orbitdesign.json" 16 60 0 60 10 reuse=dataset/margin/steam-2`.*
*Date: 2026-09-21. Wall clock 210.7 min.*
...
Depth: 23040 steps of 60 s per latitude (16.000 d) -- resolvable percentile floor 0.004%, so short-term points below that floor are located, not decided, at this depth.
...
|---|---|---|---|---|---|---|---|
| 0 | -151.9 | -12.2 | max | -10.1 | crosses at -164.1 dB: 0.3082% vs 0.03252% allowed (limit 0.0313%), x9.48 | FAIL | 0 |
| 10 | -151.1 | -13.0 | max | -10.3 | crosses at -164.1 dB: 0.3299% vs 0.03252% allowed (limit 0.0313%), x10.14 | FAIL | 0 |
| 20 | -150.8 | -13.3 | max | -10.8 | crosses at -164.1 dB: 0.3819% vs 0.03252% allowed (limit 0.0313%), x11.75 | FAIL | 0 |
| 30 | -151.9 | -12.3 | max | -11.2 | crosses at -164.1 dB: 0.5903% vs 0.03252% allowed (limit 0.0313%), x18.15 | FAIL | 0 |
| 40 | -153.8 | -10.4 | max | -10.1 | crosses at -164.1 dB: 0.7465% vs 0.03252% allowed (limit 0.0313%), x22.96 | FAIL | 0 |
| 50 | -155.4 | -9.0 | 1% | -9.5 | crosses at -164.1 dB: 1.089% vs 0.03252% allowed (limit 0.0313%), x33.50 | FAIL | 0 |
| 60 | -157.1 | -9.9 | 1% | -9.8 | crosses at -164.1 dB: 1.463% vs 0.03252% allowed (limit 0.0313%), x44.98 | FAIL | 0 |
...
|---|---|---|---|---|---|---|
| 0 | -12.2 | -18.6 | 6.4 | max / max | -10.1 / -17.5 | yes |
| 10 | -13.0 | -19.7 | 6.7 | max / max | -10.3 / -18.4 | yes |
| 20 | -13.3 | -20.2 | 6.9 | max / max | -10.8 / -19.6 | yes |
| 30 | -12.3 | -18.7 | 6.4 | max / max | -11.2 / -18.5 | yes |
| 40 | -10.4 | -18.8 | 8.4 | max / max | -10.1 / -19.2 | yes |
| 50 | -9.0 | -20.7 | 11.7 | 1% / 1% | -9.5 / -21.1 | yes |
| 60 | -9.9 | -21.6 | 11.7 | 1% / 1% | -9.8 / -21.5 | yes |
...
- Operation profile (the truth as run): `dataset\margin\steam-2-16d\steam-2-16d.opprofile.json`
- Reused R set (S.1503-4 Part B): `dataset\margin\steam-2-16d\steam-2-16d.operparams.xml`
- Reused R set, designer format (open with the operating-parameters designer): `dataset\margin\steam-2-16d\steam-2-16d.operparams.json`
- Declared pfd mask: `dataset\margin\steam-2-16d\steam-2-16d.mask.reused.xml`
