# Compliance loop: STEAM-2 cap4 (co-frequency beam capacity 4; binds on the truth)

*Produced by `dotnet run --project tests/radians.beamlab.checks -- loop "STEAM-2-cap4.opprofile.json" "STEAM-2.orbitdesign.json" 0.1 60 0 60 10`.*
*Date: 2026-09-07. Wall clock 27.2 min.*
...
| 30 | -164.5 | -5.7 | FAIL | 0 |
| 40 | -160.1 | -7.0 | FAIL | 0 |
| 50 | -157.4 | -12.8 | FAIL | 0 |
| 60 | -158.3 | -12.4 | FAIL | 0 |

**EXCEEDED at 7 of 7 latitude(s) (0, 10, 20, 30, 40, 50, 60); worst margin -12.8 dB -- sampled every 10 deg over 0..60, so a finer sweep can find worse between them -- power headroom -12.8 dB on per-beam TxEirpDbw (dB-for-dB)**
...
- Depth: 144 steps / 3493938 link samples, latitude band 10 deg.
- Derived set: min_exclude -45:22.0/-35:22.0/-25:22.0/-15:22.0/-5:22.0/5:22.0/15:22.0/25:22.0/35:26.5/45:33.0; min_elev -45:40.0/-35:40.0/-25:40.0/-15:40.0/-5:40.0/5:40.0/15:40.0/25:40.0/35:40.0/45:40.0; max_co_freq -45:4/-35:4/-25:4/-15:4/-5:4/5:4/15:4/25:4/35:4/45:4; max_co_freq_sat 16; min_angle es 0.0 / sat 2.3; es_lat -50..50
...
| 30 | -5.7 | -7.6 | 1.9 | yes |
| 40 | -7.0 | -11.7 | 4.7 | yes |
| 50 | -12.8 | -19.6 | 6.8 | yes |
| 60 | -12.4 | -15.6 | 3.2 | yes |

**ADEQUATE: E1 >= T at every latitude; widest gap 6.8 dB**

## Artefacts

Profile, R set and pfd mask come out of this one run, so they describe the same system:

- Operation profile (the truth as run): `dataset\margin\steam-2-cap4\steam-2-cap4.opprofile.json`
- Derived R set (S.1503-4 Part B): `dataset\margin\steam-2-cap4\steam-2-cap4.operparams.xml`
- Derived R set, designer format (open with the operating-parameters designer): `dataset\margin\steam-2-cap4\steam-2-cap4.operparams.json`
- Declared pfd mask: `dataset\margin\steam-2-cap4\steam-2-cap4.mask.lat10p0-ae1p0-svc-50to50-v3ba13c1d.xml`
