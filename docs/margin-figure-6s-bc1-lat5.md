...
*Produced by `dotnet run --project tests/radians.beamlab.checks -- margin 6 28800 1 5`.*
*Date: 2026-09-01. Wall clock 18.7 min.*
...
- PFD mask: alpha/deltaLongitude, latitude table -53..53 step 5, b/c 1 deg, exclusion baked (23 blocks) -- dataset/margin/margin-6s-bc1-lat5.mask.xml
...
CDFs: dataset/margin/margin-6s-bc1-lat5.{T,E1,E2}.csv (epfd dB, % time exceeded).
