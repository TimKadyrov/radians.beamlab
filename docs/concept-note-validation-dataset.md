...
**Project records:** the dataset design brief and the consumer guide (implementation project repository, `architecture/`); `dataset/*/expected/` and `dataset/*/README.md`; `docs/simulation-debate.md`; `docs/construction.html`; `docs/arc-shield-case-a.md`.
