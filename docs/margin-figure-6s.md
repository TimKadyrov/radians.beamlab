...
*Produced by `dotnet run --project tests/radians.beamlab.checks -- margin 6 28800`.*
*Date: 2026-09-01. Wall clock 18.4 min.*
...
| E1 | declared mask, D5.1.4.1 | derived R set (the filing) | -108.72 | 14886 | FAIL |
| E2 | declared mask, D5.1.4.1 | profile-composed rules | -108.72 | 14886 | FAIL |
...
|---|---|---|---|---|---|---|---|
| -154 @ 0 | -117.30 | -108.60 | -108.60 | -36.70 | -45.40 | 8.70 | 0.00 |
| -154 @ 0.017 | -124.10 | -115.50 | -115.50 | -29.90 | -38.50 | 8.60 | 0.00 |
...
**Headline: at the deepest RESOLVABLE limit point (0.017% of time; comb floor 0.0035%) the projection margin (E1 - T) is 8.60 dB; across resolvable points 1.60-8.60 dB. The sub-floor point(s) (0%) differ by up to 8.70 dB in per-run maxima -- below the comb's resolution, quoted only as such (max-epfd difference 8.74 dB, same caveat).**
...
CDFs: dataset/margin/margin-6s.{T,E1,E2}.csv (epfd dB, % time exceeded).
