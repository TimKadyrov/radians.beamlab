...
*Produced by `dotnet run --project tests/radians.beamlab.checks -- oracle 1000000 1`.*
*Date: 2026-09-03. Wall clock 44.8 min (2.3 ms/step).*
...
orbits); the selection is the scheduler's own Random policy -- uniform among the
feasible set, re-drawn every step since no hold is declared (the document's rule;
seeded inside the scheduler). Beams are irrelevant by construction
...
at longitude 0. Run here: 1000000 steps of 1 s (11.57 d); the document's run was 1e6 x 1 s.
...
| 25 | 0.127 | 0.127 | 0.121 | 0.118 | 0.094 | 0.095 | 0.055 | 0.055 | 0.042 | 0.042 | 0.036 | 0.036 |
| 30 | 0.345 | 0.341 | 0.303 | 0.296 | 0.211 | 0.212 | 0.149 | 0.149 | 0.114 | 0.114 | 0.102 | 0.103 |
| 35 | 0.544 | 0.543 | 0.470 | 0.464 | 0.320 | 0.322 | 0.244 | 0.243 | 0.188 | 0.187 | 0.176 | 0.177 |
| 40 | 0.739 | 0.737 | 0.626 | 0.623 | 0.428 | 0.430 | 0.338 | 0.337 | 0.265 | 0.264 | 0.257 | 0.258 |
| 45 | 0.906 | 0.906 | 0.760 | 0.761 | 0.538 | 0.538 | 0.433 | 0.433 | 0.345 | 0.344 | 0.348 | 0.350 |
| 50 | 1.000 | 1.000 | 0.871 | 0.871 | 0.649 | 0.649 | 0.526 | 0.526 | 0.424 | 0.423 | 0.459 | 0.461 |
| 55 | 1.000 | 1.000 | 0.945 | 0.945 | 0.754 | 0.754 | 0.614 | 0.615 | 0.502 | 0.502 | 0.602 | 0.604 |
| 60 | 1.000 | 1.000 | 1.000 | 0.993 | 0.840 | 0.841 | 0.699 | 0.700 | 0.580 | 0.579 | 0.722 | 0.724 |
| 65 | 1.000 | 1.000 | 1.000 | 1.000 | 0.917 | 0.919 | 0.783 | 0.783 | 0.657 | 0.655 | 0.821 | 0.823 |
| 70 | 1.000 | 1.000 | 1.000 | 1.000 | 0.979 | 0.979 | 0.860 | 0.860 | 0.732 | 0.730 | 0.906 | 0.908 |
| 75 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 0.925 | 0.926 | 0.805 | 0.803 | 0.981 | 0.982 |
| 80 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 0.975 | 0.975 | 0.872 | 0.871 | 1.000 | 1.000 |
| 85 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 0.932 | 0.931 | 1.000 | 1.000 |
...
- The check harness pins this agreement (V35) on a short comb so a selection-side
  regression cannot move a margin figure unseen.
