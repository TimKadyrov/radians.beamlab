...
*Produced by `dotnet run --project tests/radians.beamlab.checks -- margin 6 28800 2`.*
*Date: 2026-09-01. Wall clock 18.0 min.*

*Variant of the baseline (docs/margin-figure.md): same system, same
victim -- only the comb and/or the mask b/c grid named above differ,
isolating sampling and mask-grid contributions respectively.*
...
- PFD mask: alpha/deltaLongitude, latitude table -53..53 step 10 (pinned), b/c 2 deg, exclusion baked (13 blocks) -- dataset/margin/margin-6s-bc2.mask.xml
...
| E1 | declared mask, D5.1.4.1 | derived R set (the filing) | -110.50 | 14886 | FAIL |
| E2 | declared mask, D5.1.4.1 | profile-composed rules | -110.50 | 14886 | FAIL |
...
|---|---|---|---|---|---|---|---|
| -154 @ 0 | -117.30 | -110.40 | -110.40 | -36.70 | -43.60 | 6.90 | 0.00 |
| -154 @ 0.017 | -124.10 | -117.30 | -117.30 | -29.90 | -36.70 | 6.80 | 0.00 |
| -172 @ 2.857 | -147.50 | -146.30 | -145.40 | -24.50 | -25.70 | 1.20 | 0.90 |
| -182 @ 28.571 | -152.20 | -148.80 | -148.70 | -29.80 | -33.20 | 3.40 | 0.10 |
| -187.4 @ 100 | -287.40 | -287.40 | -287.40 | 100.00 | 100.00 | 0.00 | 0.00 |

**Headline: at the deepest RESOLVABLE limit point (0.017% of time; comb floor 0.0035%) the projection margin (E1 - T) is 6.80 dB; across resolvable points 1.20-6.80 dB. The sub-floor point(s) (0%) differ by up to 6.90 dB in per-run maxima -- below the comb's resolution, quoted only as such (max-epfd difference 6.96 dB, same caveat).**
...
CDFs: dataset/margin/margin-6s-bc2.{T,E1,E2}.csv (epfd dB, % time exceeded).
