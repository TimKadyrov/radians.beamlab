# Compliance loop: STEAM-2-gsoE30 (STEAM-2 profile unchanged; GSO satellite +30 deg east of the earth station, 0.5 d, declaration reused from the record)

*Produced by `dotnet run --project tests/radians.beamlab.checks -- loop "STEAM-2-gsoE30.opprofile.json" "STEAM-2.orbitdesign.json" 0.5 60 0 60 10 reuse=dataset/margin/steam-2 gso=30`.*
*Date: 2026-09-21. Wall clock 4.0 min.*
...
- Victim: earth station at longitude 0, GSO satellite +30 deg, dish 1.00 m (the limit row's own reference diameter).
...
|---|---|---|---|---|---|---|---|
| 0 | -158.0 | -6.1 | 0.029% | -8.1 | crosses at -164.1 dB: 0.1389% vs 0.03252% allowed (limit 0.0313%), x4.27 | FAIL | 0 |
| 10 | -164.5 | +0.4 | 0.029% | -1.6 | crosses at -164.5 dB: 0.1389% vs 0.04412% allowed (limit 0.04247%), x3.15 | FAIL | 0 |
| 20 | -158.0 | -6.1 | 0.029% | -8.1 | crosses at -164.1 dB: 0.1389% vs 0.03252% allowed (limit 0.0313%), x4.27 | FAIL | 0 |
| 30 | -153.8 | -10.4 | 0.029% | -12.4 | crosses at -164.1 dB: 0.6944% vs 0.03252% allowed (limit 0.0313%), x21.36 | FAIL | 0 |
| 40 | -161.3 | -3.9 | 1% | -5.3 | crosses at -164.1 dB: 0.4167% vs 0.03252% allowed (limit 0.0313%), x12.81 | FAIL | 0 |
| 50 | -156.5 | -10.2 | 1% | -12.5 | crosses at -164.1 dB: 1.389% vs 0.03252% allowed (limit 0.0313%), x42.71 | FAIL | 0 |
| 60 | -160.8 | -7.3 | 1% | -7.5 | crosses at -164.4 dB: 0.8333% vs 0.04088% allowed (limit 0.03935%), x20.39 | FAIL | 0 |
...
**EXCEEDED at 7 of 7 latitude(s) (0, 10, 20, 30, 40, 50, 60); worst margin -12.5 dB under the limit-curve rule -- sampled every 10 deg over 0..60, so a finer sweep can find worse between them -- power headroom -12.5 dB on per-beam TxEirpDbw (dB-for-dB)**
...
|---|---|---|---|---|---|---|
| 0 | -6.1 | -12.9 | 6.8 | 0.029% / 0.029% | -8.1 / -14.9 | yes |
| 10 | +0.4 | -6.9 | 7.3 | 0.029% / 0.029% | -1.6 / -8.9 | yes |
| 20 | -6.1 | -13.8 | 7.7 | 0.029% / 0.029% | -8.1 / -15.8 | yes |
| 30 | -10.4 | -17.5 | 7.1 | 0.029% / 0.029% | -12.4 / -19.5 | yes |
| 40 | -3.9 | -12.4 | 8.5 | 1% / 0.286% | -5.3 / -14.5 | yes |
| 50 | -10.2 | -22.2 | 12.0 | 1% / 1% | -12.5 / -23.3 | yes |
| 60 | -7.3 | -19.2 | 11.9 | 1% / 1% | -7.5 / -19.5 | yes |
...
- Operation profile (the truth as run): `dataset\margin\steam-2-gsoe30\steam-2-gsoe30.opprofile.json`
- Reused R set (S.1503-4 Part B): `dataset\margin\steam-2-gsoe30\steam-2-gsoe30.operparams.xml`
- Reused R set, designer format (open with the operating-parameters designer): `dataset\margin\steam-2-gsoe30\steam-2-gsoe30.operparams.json`
- Declared pfd mask: `dataset\margin\steam-2-gsoe30\steam-2-gsoe30.mask.reused.xml`
