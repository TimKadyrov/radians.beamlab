# Compliance loop: STEAM-2-gsoE45-2d (STEAM-2 profile unchanged; GSO satellite +45 deg east of the earth station, 2.0 d, declaration reused from the record)

*Produced by `dotnet run --project tests/radians.beamlab.checks -- loop "STEAM-2-gsoE45-2d.opprofile.json" "STEAM-2.orbitdesign.json" 2 60 0 60 10 reuse=dataset/margin/steam-2 gso=45`.*
*Date: 2026-09-21. Wall clock 13.7 min.*
...
|---|---|---|---|---|---|---|---|
| 0 | -156.5 | -7.6 | 0.029% | -8.6 | crosses at -164.1 dB: 0.6597% vs 0.03252% allowed (limit 0.0313%), x20.29 | FAIL | 0 |
| 10 | -155.2 | -9.1 | 0.286% | -10.2 | crosses at -164.1 dB: 0.7639% vs 0.03252% allowed (limit 0.0313%), x23.49 | FAIL | 0 |
| 20 | -154.3 | -9.8 | 0.029% | -10.2 | crosses at -164.1 dB: 0.6597% vs 0.03252% allowed (limit 0.0313%), x20.29 | FAIL | 0 |
| 30 | -156.8 | -7.8 | 0.286% | -8.4 | crosses at -164.1 dB: 0.7986% vs 0.03252% allowed (limit 0.0313%), x24.56 | FAIL | 0 |
| 40 | -156.1 | -9.0 | 0.286% | -10.1 | crosses at -164.1 dB: 1.076% vs 0.03252% allowed (limit 0.0313%), x33.10 | FAIL | 0 |
| 50 | -158.5 | -9.0 | 1% | -9.0 | crosses at -164.1 dB: 1.285% vs 0.03252% allowed (limit 0.0313%), x39.51 | FAIL | 0 |
| 60 | -159.3 | -8.9 | 1% | -8.9 | crosses at -164.1 dB: 1.285% vs 0.03252% allowed (limit 0.0313%), x39.51 | FAIL | 0 |
...
**EXCEEDED at 7 of 7 latitude(s) (0, 10, 20, 30, 40, 50, 60); worst margin -10.2 dB under the limit-curve rule -- sampled every 10 deg over 0..60, so a finer sweep can find worse between them -- power headroom -10.2 dB on per-beam TxEirpDbw (dB-for-dB)**
...
|---|---|---|---|---|---|---|
| 0 | -7.6 | -15.3 | 7.7 | 0.029% / 0.286% | -8.6 / -16.4 | yes |
| 10 | -9.1 | -18.0 | 8.9 | 0.286% / 0.286% | -10.2 / -18.3 | yes |
| 20 | -9.8 | -17.5 | 7.7 | 0.029% / 0.029% | -10.2 / -18.5 | yes |
| 30 | -7.8 | -15.6 | 7.8 | 0.286% / 0.286% | -8.4 / -16.4 | yes |
| 40 | -9.0 | -18.2 | 9.2 | 0.286% / 1% | -10.1 / -19.4 | yes |
| 50 | -9.0 | -20.4 | 11.4 | 1% / 1% | -9.0 / -20.4 | yes |
| 60 | -8.9 | -20.9 | 12.0 | 1% / 1% | -8.9 / -20.8 | yes |
...
- Operation profile (the truth as run): `dataset\margin\steam-2-gsoe45-2d\steam-2-gsoe45-2d.opprofile.json`
- Reused R set (S.1503-4 Part B): `dataset\margin\steam-2-gsoe45-2d\steam-2-gsoe45-2d.operparams.xml`
- Reused R set, designer format (open with the operating-parameters designer): `dataset\margin\steam-2-gsoe45-2d\steam-2-gsoe45-2d.operparams.json`
- Declared pfd mask: `dataset\margin\steam-2-gsoe45-2d\steam-2-gsoe45-2d.mask.reused.xml`
