# Compliance loop: STEAM-2-gsoE60 (STEAM-2 profile unchanged; GSO satellite +60 deg east of the earth station, 0.5 d, declaration reused from the record)

*Produced by `dotnet run --project tests/radians.beamlab.checks -- loop "STEAM-2-gsoE60.opprofile.json" "STEAM-2.orbitdesign.json" 0.5 60 0 60 10 reuse=dataset/margin/steam-2 gso=60`.*
...
|---|---|---|---|---|---|---|---|
| 0 | -161.2 | -4.4 | 1% | -4.9 | crosses at -164.1 dB: 0.2778% vs 0.03252% allowed (limit 0.0313%), x8.54 | FAIL | 0 |
| 10 | -160.3 | -5.0 | 1% | -7.8 | crosses at -164.1 dB: 0.5556% vs 0.03252% allowed (limit 0.0313%), x17.09 | FAIL | 0 |
| 20 | -159.3 | -8.6 | 1% | -10.4 | crosses at -164.2 dB: 1.25% vs 0.03509% allowed (limit 0.03378%), x35.62 | FAIL | 0 |
| 30 | -160.2 | -7.2 | 1% | -7.4 | crosses at -164.1 dB: 0.5556% vs 0.03252% allowed (limit 0.0313%), x17.09 | FAIL | 0 |
| 40 | -159.6 | -10.3 | 1% | -10.4 | crosses at -164.1 dB: 1.667% vs 0.03252% allowed (limit 0.0313%), x51.26 | FAIL | 0 |
| 50 | -160.1 | -8.8 | 1% | -10.3 | crosses at -164.1 dB: 1.111% vs 0.03252% allowed (limit 0.0313%), x34.17 | FAIL | 0 |
| 60 | -161.9 | -6.7 | 1% | -7.0 | crosses at -164.4 dB: 0.5556% vs 0.04088% allowed (limit 0.03935%), x13.59 | FAIL | 0 |
...
**EXCEEDED at 7 of 7 latitude(s) (0, 10, 20, 30, 40, 50, 60); worst margin -10.4 dB under the limit-curve rule -- sampled every 10 deg over 0..60, so a finer sweep can find worse between them -- power headroom -10.4 dB on per-beam TxEirpDbw (dB-for-dB)**
...
|---|---|---|---|---|---|---|
| 0 | -4.4 | -11.3 | 6.9 | 1% / 1% | -4.9 / -11.7 | yes |
| 10 | -5.0 | -12.2 | 7.2 | 1% / 1% | -7.8 / -14.5 | yes |
| 20 | -8.6 | -19.2 | 10.6 | 1% / 1% | -10.4 / -19.5 | yes |
| 30 | -7.2 | -15.1 | 7.9 | 1% / 1% | -7.4 / -15.1 | yes |
| 40 | -10.3 | -19.8 | 9.5 | 1% / 1% | -10.4 / -19.8 | yes |
| 50 | -8.8 | -19.4 | 10.6 | 1% / 1% | -10.3 / -19.8 | yes |
| 60 | -6.7 | -15.8 | 9.1 | 1% / 1% | -7.0 / -15.8 | yes |
...
- Operation profile (the truth as run): `dataset\margin\steam-2-gsoe60\steam-2-gsoe60.opprofile.json`
- Reused R set (S.1503-4 Part B): `dataset\margin\steam-2-gsoe60\steam-2-gsoe60.operparams.xml`
- Reused R set, designer format (open with the operating-parameters designer): `dataset\margin\steam-2-gsoe60\steam-2-gsoe60.operparams.json`
- Declared pfd mask: `dataset\margin\steam-2-gsoe60\steam-2-gsoe60.mask.reused.xml`
